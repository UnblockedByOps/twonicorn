...
dependency_links = [
    ...
    'https://github.com/CityGrid/pyramid_ldap/archive/0.2.zip#egg=pyramid_ldap-0.2#md5=915f23ef8935b3e3e3cec0f8cf2b4f4f'
    ]
...
setup(name='TwonicornWeb',
      ...
      url='https://github.com/CityGrid/twonicorn',
      license='Apache',
